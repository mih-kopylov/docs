...
Ory is a security software company, building a global zero trust network for authentication, authorization, and access control by
developing and adopting open source software (Ory, Kubernetes, Crossplane, Linux, ...), open standards (OAuth2, OpenID Connect,
MITREid, Ory, ...), and combining centuries in security and industry expertise.
...
- The Ory Identity Service is developed as an open source project called [Ory Kratos](https://github.com/ory/kratos).
- The Ory OAuth2 & OpenID Connect Service is developed as an open source project called [Ory Hydra](https://github.com/ory/hydra).
- The Ory Permission Service is developed as an open source project called [Ory Keto](https://github.com/ory/keto).
...
Ory is production ready and is on track to secure one trillion API requests in 2022. Some parts of Ory are actively being
developed. To learn more about roadmap and planned features head over to [the roadmap](./ecosystem/roadmap.md) and
