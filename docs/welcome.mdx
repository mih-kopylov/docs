...
combines open source software (Ory, Kubernetes, Crossplane, Cockroach, Linux), open standards (Ory, OAuth2, OpenID Connect,
MITREid, WebAuthn, TOTP), and centuries in combined open source, security, and industry expertise.

[Ory Cloud](https://console.ory.sh) is developed in an open-source approach to foster collaboration, reduce security supply-chain
risk, and introduce the open standard for internet security.
