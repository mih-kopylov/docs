...
Ory is a security software company building a global zero trust network for authentication, authorization, and access control. Ory
fuses open source software (Ory, Kubernetes, Crossplane, Cockroach, Linux, Istio) and open standards (Ory, OAuth2, OpenID Connect,
MITREid, WebAuthn, TOTP) with centuries in combined open source, security, operational, and industry expertise.

[Ory Cloud](https://console.ory.sh)'s core infrastructure components are open-source to make security accessible, foster
collaboration, reduce security supply-chain risk, and introduce the open standard for internet security. Being open source, Ory
improves the security of everyone in an age of global volatility:

- The Ory Identity Service is developed as an open source project called [Ory Kratos](https://github.com/ory/kratos), introducing
  a new open standard for identity management.
- The Ory OAuth2 & OpenID Connect Service is developed as an open source project called [Ory Hydra](https://github.com/ory/hydra),
  implementing 15+ IETF and OpenID standards.
- The Ory Permission Service is developed as an open source project called [Ory Keto](https://github.com/ory/keto), implementing
  _[Zanzibar: Google’s Consistent, Global Authorization System](https://research.google/pubs/pub48190/)_ by Google.

Ory develops and maintains many additional open source projects, such as the Ory Zero Trust Identity & Access Proxy
[Ory Oathkeeper](https://github.com/ory/oathkeeper), developer tooling such as [Ory Dockertest](http://github.com/ory/dockertest)
and language-specific libraries such as [Ory Ladon](https://github.com/ory/ladon).

Ory is production ready, on track to secure one trillion API requests in 2022, and being improved daily.
...
Ory Cloud is the commercial offering of Ory and is built on top of our popular open source software. Our goal with Ory Cloud is to
offer a planet-scale, low-latency, resilient, and secure service that's easy to use and set up.

In short: Ory Cloud is the most convenient and straightforward way to run Ory. Sign up at
...
The Ory Console is the management UI of Ory Cloud. It offers capabilities such as showing and searching for identities, managing
user sessions, and gaining valuable insights in the form of dashboards and customization.

### Managed UI

The Managed UI implements screens such as login, registration, account recovery, account setting, and account verification. This
allows for fast adoption of Ory.
...
Ory Cloud incorporates the open source [Ory Kratos](https://www.ory.sh/kratos) project and offers:
...
**No!** Ory Cloud is our commercial offering with which we generate revenue to build more open source and more features in Ory
Cloud. Our value proposition and vision for Ory Cloud is to incorporate and advance the open source ecosystem and add additional
services which aren't possible to open source (for example Analytics, SLAs, SRE, Low-Latency).

Ory Cloud and our open source software are interlinked. While we've made some modifications to the open source to make it work
better in our multi-tenant environment and operational (SRE) model, we're using the same code base, APIs, features, and
configurations for Ory Cloud.
...
only impact Ory Cloud will have is that it will accelerate development and enable us to spend more resources on the open source!

## New to Ory ?

- [Ory Projects Overview.](/ecosystem/projects.md) What is Ory ? Learn about the open source projects at the heart of Ory:
...
- [Sign up](https://console.ory.sh/registration) for a free Developer account in Ory Cloud.
...
- The best way to run Ory: Learn about [Ory Cloud Projects](https://www.ory.sh/docs/concepts/project) and
